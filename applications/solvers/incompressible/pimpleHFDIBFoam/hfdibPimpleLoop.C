...
#include "hfdibPimpleLoop.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(hfdibPimpleLoop, 0);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

bool Foam::hfdibPimpleLoop::read()
{
    nCorrPimple_ =
...
Foam::hfdibPimpleLoop::hfdibPimpleLoop(const solutionControl& control, openHFDIBDEM& oHFDIBDEM)
:
    control_(control),
    nCorrPimple_(-1),
    corrPimple_(0),
    converged_(false),
    openHFDIBDEM_(oHFDIBDEM)
{}


// * * * * * * * * * * * * * * * * Destructor  * * * * * * * * * * * * * * * //

Foam::hfdibPimpleLoop::~hfdibPimpleLoop()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

bool Foam::hfdibPimpleLoop::loop(correctorConvergenceControl& convergence)
{
    read();
    ...
    // Set up the next loop
    {
        ...
        if (!firstPimpleIter() && corrPimple_ >= openHFDIBDEM_.minPimpleLoops() && convergence.corrCriteriaSatisfied())
        {
